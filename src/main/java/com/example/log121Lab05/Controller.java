 ...
 * @Description: Controller is the heart of our application. It handles all the events generated by the user (Mouse Clicks, Drags, ect) and calls the necessary methods.
 * It also acts as our CareTaker for the Memento design pattern and the Invoker for the Command pattern
 */
...
public class Controller implements IObserver, Initializable {
    ...
    /**
     * Creates and executes the LoadImage command
     */
    @FXML
    ...
    /**
     * Creates and executes the Translate command, passes to it as a parameter the mouse movement
     * @param event The event holding data about how much the mouse moved
     */
    @FXML
    ...
    /**
     * Sets the selected perspective as perspective 1
     * @param event
     */
    @FXML
    ...
    /**
     * Sets the selected perspective as perspective 2
     * @param event
     */
    @FXML
    ...
    /**
     * Creates and Execute the Undo command. Passes the last Memento as a parameter
     */
    @FXML
    public void undo() {
        if (!history.isEmpty()) {
    ...
    /**
     * Creates and execute the Copy command, passes the selected perspective
     */
    @FXML
    public void copy() {
    ...
    /**
     * Creates and executes the Paste command with the POSITION type as a parameter
     */
    @FXML
    ...
    /**
     * Creates and executes the Paste command with the ZOOM type as a parameter
     */
    @FXML
    ...
    /**
     * Creates and executes the Paste command with the ALL type as a parameter
     */
    @FXML
    ...
    /**
     * Creates and executes the Save command
     */
    @FXML
    public void save() {
    ...
    /**
     * Creates and executes the Load command
     */
    @FXML
    public void load() {
    ...
    /**
     * Called upon scrolling on a perspective, creates and executes the Zoom command
     * @param e
     */
    ...
    /**
     * Updates the view with the new data from the arg. Called when there are changes within the State
     * @param o The Observable object, typically the State
    ...
    /**
     * Function called after the instantiation of the view components that initializes some values
     * @param url
    ...
    /**
     * Method purely dedicated to updating perspectives
     * @param p
     */
    ...
    /**
     * Returns the unique instance if it is not null
     * @return
     */
